...
export default function FinalCTA() {
  return (
    <section className="relative overflow-hidden border-t border-line bg-ink px-6 py-32 md:px-10 lg:px-14 lg:py-44">
      <div
        aria-hidden
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(201,161,90,0.4) 0%, transparent 65%)",
        }}
      />
      <div className="relative mx-auto flex max-w-[1600px] flex-col items-center text-center">
        ...
        <Reveal delay={100}>
          <h2 className="mt-8 max-w-4xl font-display text-[clamp(2.5rem,7vw,6rem)] italic leading-[1.02] text-paper text-balance">
